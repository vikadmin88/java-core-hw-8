        ...
        for (Shape shape: getShapes()) {
            if (shape != null) {
                ...
                if (shape instanceof ICircle) {
                    ...
                    System.out.printf(", Extended params[X/%f, Y/%f, R/%f]", shapeExt.getX(), shapeExt.getY(), shapeExt.getRadius());
                }
                if (shape instanceof ILine) {
                    Line shapeExt = (Line) shape;
                    System.out.printf(", Extended params[X1/%f, Y1/%f, X2/%f, Y2/%f, L/%f]", shapeExt.getX(), shapeExt.getY(), shapeExt.getX2(), shapeExt.getY2(), shapeExt.getLength());
                }
                System.out.println(" ");
            }
            i++;
